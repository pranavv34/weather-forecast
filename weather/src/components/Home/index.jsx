...
import { Box, Container, Grid, Link, SvgIcon, Typography, Button } from '@mui/material';
...
import { Route, Routes, Navigate, useNavigate } from 'react-router-dom'; // Import the necessary items
